...
function ContentContainer({ className, children }: ContentContainerProps) {
  return (
    <div className={cn('flex flex-col overflow-x-hidden w-full max-w-screen-2xl min-h-dvh mx-auto pl-5 sm:pl-[9.625rem] md:pl-[18.5rem] pr-5 pt-20 pb-24', className)}>
